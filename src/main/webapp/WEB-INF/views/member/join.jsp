...
<script src="//t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
 ...
 <form name="m" method="post" action="/member_join_ok" id="joinForm" name="joinForm"
     ...
     <select name="m_phone01" id="m_phone01" style="width:80px; height:30px; margin-left:12px; margin-right:12px;">
      <c:forEach var="p" items="${phone}">
       <option value="${p}">${p}</option>
        ...
        </select>-<input name="m_phone02" id="m_phone02" size="4" maxlength="4" >-
       <input name="m_phone03" id="m_phone03" size="4" maxlength="4" >
     </td>
    </tr>
...
제2조(정의)
  ...
  ① “몰”이란 모빌리아 주식회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
o 부정거래 방지 및 쇼핑몰 운영방침에 따른 보관 : 2년
나. 관련 법령에 의한 정보보유 사유
...
※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.
  ...
  <input type="submit" class="OK" value="회원가입">
 </form>
